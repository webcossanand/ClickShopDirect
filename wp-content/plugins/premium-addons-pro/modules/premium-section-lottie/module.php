...
/**
 * Class Module For Premium Lottie container addon.
 */
class Module extends Module_Base {
	...
	public function register_controls( $element ) {
		...
		$doc_url = Helper_Functions::get_campaign_link( $url, 'lottie-addon', 'wp-editor', 'get-support' );
		...
		$repeater->add_responsive_control(
			...
			array(
				...
				'separator'   => 'before',
				'selectors'   => array(
					'{{WRAPPER}} {{CURRENT_ITEM}}.premium-lottie-canvas, {{WRAPPER}} {{CURRENT_ITEM}}.premium-lottie-svg svg' => 'width: {{SIZE}}{{UNIT}} !important; height: {{SIZE}}{{UNIT}} !important',
				),
			)
		);
	...
	public function check_assets_enqueue( $element ) {
		...
		if ( ! empty( $settings[ 'premium_lottie_switcher' ] ) ) {
