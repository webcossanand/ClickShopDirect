...
/**
 * Class Module For Premium Blob Generator container addon.
 */
class Module extends Module_Base {
	...
	public function register_controls( $element ) {
		...
		$doc_link = Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/elementor-animated-blob-generator-section-addon-tutorial/', 'blob-addon', 'wp-editor', 'get-support' );
