...
/**
 * Class Module For Premium Parallax container addon.
 */
class Module extends Module_Base {
	...
	public function enqueue_scripts() {
		...
		// $draw_svg determines if SVG draw functionality is enabled, affecting whether the pa-motionpath script should be enqueued.
			...
			if ( 'multi' !== $parallax && 'automove' !== $parallax ) {
				...
				$parallax_settings = array_merge(
					...
					array(
						...
						'size'    => isset( $settings['background_size'] ) ? $settings['background_size'] : 'cover',
						'repeat'  => isset( $settings['background_repeat'] ) ? $settings['background_repeat'] : 'no-repeat',
					)
				);
	...
	public function check_assets_enqueue( $element ) {
		...
		if ( ! empty( $settings[ 'premium_parallax_switcher' ] ) ) {
