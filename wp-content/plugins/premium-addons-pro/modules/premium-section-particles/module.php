...
/**
 * Class Module For Premium Particles container addon.
 */
class Module extends Module_Base {
	...
	public function register_controls( $element ) {
		...
		$element->add_control(
			...
			array(
				...
				'frontend_available' => true,
				'condition'          => array(
					'premium_particles_switcher' => 'yes',
				),
			)
		);
	...
	public function check_script_enqueue( $element ) {
		...
		if ( $pg_particles_enabled || ! empty( $settings[ 'premium_particles_switcher' ] ) ) {
