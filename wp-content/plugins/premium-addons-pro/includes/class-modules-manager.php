...
final class Manager {
	...
	public function run_modules_extender() {
		...
		add_action( 'pa_showcase_clip_scroll', array( $this, 'add_showcase_clip_scroll' ) );
		...
		// Extend Countdown widget controls.
		add_filter( 'pa_countdown_options', array( $this, 'pa_countdown_options' ) );

		// Extend AJAX search widget controls.
		add_action( 'pa_search_effects_options', array( $this, 'add_search_effects_options' ), 10, 2 );
		add_action( 'pa_search_keyword_button_style', array( $this, 'add_keyword_remove_button_style' ), 10, 2 );
		add_action( 'pa_search_select_field_style', array( $this, 'add_select_field_style' ), 10, 2 );

		// Extend Mobile Menu widget controls.
		add_action( 'pa_mobile_menu_badge_controls', array( $this, 'add_mobile_menu_badge_controls' ) );
		add_action( 'pa_mobile_menu_carousel_controls', array( $this, 'add_mobile_menu_carousel_controls' ) );
		add_action( 'pa_mobile_menu_badge_style', array( $this, 'add_mobile_menu_badge_style' ) );
		add_action( 'pa_mobile_menu_badge_style_tab', array( $this, 'add_mobile_menu_badge_style_tab' ) );
		add_action( 'pa_mobile_menu_indicator_carousel_style', array( $this, 'add_mobile_menu_indicator_carousel_style' ) );

		// Extend Animated Text widget controls.
		add_action( 'pa_atext_highlight_controls', array( $this, 'add_atext_highlight_controls' ) );
		add_action( 'pa_atext_shape_style', array( $this, 'add_atext_shape_style' ) );

		// Extend Woo Categories Listing widget.
		add_action( 'pa_woo_cats_carousel', array( $this, 'add_woo_cats_carousel_controls' ) );
		add_action( 'pa_woo_cats_carousel_style', array( $this, 'add_woo_cats_carousel_style' ) );
		add_action( 'pa_woo_cats_individual_style', array( $this, 'add_woo_cats_individual_style' ) );

		// Extend Woo CTA widget.
		add_action( 'pa_woo_cta_notice_controls', array( $this, 'add_woo_cta_notice_controls' ) );
		add_action( 'pa_woo_cta_text_controls', array( $this, 'add_woo_cta_text_controls' ) );

		// Extend Woo Mini Cart widget.
		add_action( 'pa_woo_mini_cart_window_controls', array( $this, 'add_woo_mini_cart_window_controls' ) );
		add_action( 'pa_woo_mini_cart_window_style_controls', array( $this, 'add_woo_mini_cart_window_style_controls' ) );
	}
	...
	public function add_tcloud_sphere_controls( $elem ) {
		...
		$elem->add_control(
			'colors_target',
			array(
				'label'              => __( 'Apply Colors On', 'premium-addons-pro' ),
				'type'               => Controls_Manager::SELECT,
				'options'            => array(
					'text'       => __( 'Text', 'premium-addons-pro' ),
					'background' => __( 'Background', 'premium-addons-pro' ),
				),
				'default'            => 'text',
				'frontend_available' => true,
				'condition'          => array(
		...
		$elem->add_control(
			'sphere_term_padding',
			array(
				'label'              => __( 'Padding (px)', 'premium-addons-pro' ),
				'type'               => Controls_Manager::SLIDER,
				'range'              => array(
					'px' => array(
						'min' => 0,
		...
		$elem->add_control(
			'sphere_term_radius',
			array(
				'label'              => __( 'Radius (px)', 'premium-addons-pro' ),
				'type'               => Controls_Manager::SLIDER,
				'range'              => array(
					'px' => array(
						'min' => 0,
	...
	public function pa_ticker_options() {
		...
		$options = array(
			'layouts'          => array(
				'layout-1' => __( 'Layout 1', 'premium-addons-pro' ),
				'layout-2' => __( 'Layout 2', 'premium-addons-pro' ),
				'layout-3' => __( 'Layout 3', 'premium-addons-pro' ),
				'layout-4' => __( 'Layout 4', 'premium-addons-pro' ),
			),
	...
	public function add_ticker_stock_query( $elem ) {
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'CURRENCY_EXCHANGE_RATE' => __( 'Currencies', 'premium-addons-pro' ),
					'GLOBAL_QUOTE'           => __( 'Equities', 'premium-addons-pro' ),
				),
		...
		$elem->add_control(
			...
			array(
				...
				'raw'             => __( 'Returns the realtime exchange rate for any pair of digital currency (e.g., Bitcoin) or physical currency (e.g., USD). <b>Cryptocurrecies must start with "/", e.g (/BTC)', 'premium-addons-pro' ),
		...
		$elem->add_control(
			...
			array(
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => __( 'Returns the stock price details for a token/symbol of your choice.', 'premium-addons-pro' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
				'condition'       => array(
					'post_type_filter' => 'stock',
		...
		$elem->add_control(
			'symbol',
			array(
				'label'       => __( 'Symbol', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Enter the stock tokens/symbols you want to query up to 5 symbols separated by ",". Example: AAPL,MSFT,INTC', 'premium-addons-pro' ),
				'label_block' => true,
		...
		$elem->add_control(
			'from_currency',
			array(
				'label'       => __( 'Exchange From', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Enter the currency you want exchange from up to 5 symbols separated by ",". Example: USD,EUR,GBP', 'premium-addons-pro' ),
				'label_block' => true,
				'default'     => 'USD,EUR,GBP',
				'condition'   => array(
					'post_type_filter' => 'stock',
		...
		$elem->add_control(
			'to_currency',
			array(
				'label'       => __( 'Exchange To', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => 'EUR,JPY,CAD',
				'description' => __( 'Enter the currencies you want to exchange to separated by ",". Example: EUR,JPY,CAD', 'premium-addons-pro' ),
				'label_block' => true,
				'condition'   => array(
					'post_type_filter' => 'stock',
					'req_function'     => 'CURRENCY_EXCHANGE_RATE',
		...
		$elem->add_control(
			'curr_change',
			array(
				'label'       => __( 'Show Change Details', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __( 'Display the change details depending on the previously cached data.', 'premium-addons-pro' ),
				// 'render_type'  => 'template',
				'condition'   => array(
					'post_type_filter' => 'stock',
					'req_function'     => 'CURRENCY_EXCHANGE_RATE',
		...
		$elem->add_control(
			...
			array(
				...
				'separator' => 'before',
				'options'   => array(
					1  => __( 'Hour', 'premium-addons-pro' ),
					3  => __( '3 Hours', 'premium-addons-pro' ),
					6  => __( '6 Hours', 'premium-addons-pro' ),
					12 => __( '12 Hours', 'premium-addons-pro' ),
					24 => __( 'Day', 'premium-addons-pro' ),
					48 => __( '2 Days', 'premium-addons-pro' ),
				),
				'default'   => 3,
				'condition' => array(
					'post_type_filter' => 'stock',
		...
		$elem->add_control(
			'alter_api_key',
			array(
				'label'       => __( 'Alternative API Key', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
		...
		$elem->add_control(
			'currencies',
			array(
				'label'       => __( 'Currencies', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Enter the Currencies symbols you want to query up to 5 symbols separated by ",". Example: USD,EUR,JPY, You can check the available currencies <a href="https://www.goldapi.io/dashboard" target="_blank">here -> Currency Code.</a>', 'premium-addons-pro' ),
				'label_block' => true,
				'default'     => 'USD,EUR,JPY',
				'condition'   => array(
					'post_type_filter' => 'gold',
	...
	public function add_ticker_stock_controls( $elem ) {
		...
		$elem->start_controls_section(
			...
			array(
				'label'     => __( 'Stock Options', 'premium-addons-pro' ),
				'condition' => array(
		...
		$elem->add_control(
			'show_symbol_icon',
			array(
				'label'     => __( 'Show Symbol Icon', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'condition' => array(
					'post_type_filter' => 'stock',
				),
		...
		$repeater->add_control(
			...
			array(
				'label'       => __( 'Symbol', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Use this to add the currency/company symbol that the image below will be linked to. For example, USD or AAPL.', 'premium-addons-pro' ),
				'label_block' => true,
			)
		);
		...
		$repeater->add_control(
			'symbol_img',
			array(
				'label' => __( 'Symbol Image', 'premium-addons-pro' ),
		...
		$elem->add_control(
			...
			array(
				'label'       => __( 'Custom Symbols Icons', 'premium-addons-pro' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
		...
		$elem->add_responsive_control(
			'symbol_icon_size',
			array(
				'label'     => __( 'Icon Size (px)', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => array(
					'size' => 30,
				),
		...
		$elem->add_control(
			'symbol_names_sw',
			array(
				'label'     => __( 'Show Symbols Names', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'condition' => array(
					'req_function'     => 'GLOBAL_QUOTE',
					'post_type_filter' => 'stock',
		...
		$elem->add_control(
			'symbol_name',
			array(
				'label'       => __( 'Symbols Names', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Enter the stock tokens\' names you want to display corresponding to the above symbols and separated by ",". Example: Apple Inc,Microsoft Corp,Intel Corporation', 'premium-addons-pro' ),
				'label_block' => true,
		...
		$elem->add_control(
			'show_symbol',
			array(
				'label'     => __( 'Show Symbol', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'condition' => array(
					'req_function'     => 'GLOBAL_QUOTE',
		...
		$elem->add_control(
			'show_price',
			array(
				'label'   => __( 'Show Price', 'premium-addons-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			)
		);
		...
		$elem->add_control(
			'show_change',
			array(
				'label'      => __( 'Show Change', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SWITCHER,
				'default'    => 'yes',
		...
		$elem->add_control(
			'show_change_per',
			array(
				'label'      => __( 'Show Change Percent', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SWITCHER,
				'default'    => 'yes',
				'conditions' => $common_cond,
			)
		...
		$elem->add_control(
			'change_indicator',
			array(
				'label'      => __( 'Change Indicator', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SELECT,
				'options'    => array(
					'sign'  => __( '+/- Sign', 'premium-addons-pro' ),
					'arrow' => __( 'Arrow', 'premium-addons-pro' ),
				),
				'default'    => 'arrow',
				'conditions' => $common_cond,
			)
		...
		$elem->add_control(
			'arrow_style',
			array(
				'label'      => __( 'Arrow Style', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SELECT,
				'options'    => array(
					'fas fa-caret'          => __( 'Style 1', 'premium-addons-pro' ),
					'fas fa-long-arrow-alt' => __( 'Style 2', 'premium-addons-pro' ),
					'fas fa-arrow'          => __( 'Style 3', 'premium-addons-pro' ),
					'fas fa-chevron'        => __( 'Style 4', 'premium-addons-pro' ),
				),
		...
		$elem->add_control(
			'decimal_places',
			array(
				'label'   => __( 'Decimal Places', 'premium-addons-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 0,
				'default' => 2,
			)
		...
		$elem->add_responsive_control(
			'stock_ele_min_width',
			array(
				'label'       => __( 'Minimum Width (px)', 'premium-addons-pro' ),
				'description' => __( 'Use this option to add equal spacing to the element data.', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SLIDER,
				'size_units'  => array( 'px' ),
				'range'       => array(
					'px' => array(
	...
	public function add_ticker_stock_style( $elem ) {
		...
		$elem->add_group_control(
			...
			array(
				...
				'label'     => __( 'Symbol Icon Shadow', 'premium-addons-pro' ),
		...
		$elem->add_responsive_control(
			'symbol_icon_margin',
			array(
				'label'      => __( 'Symbol Icon Margin', 'premium-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px' ),
				'selectors'  => array(
		...
		$elem->add_control(
			...
			array(
				'label'     => __( 'Price Details', 'premium-addons-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => array(
					'post_type_filter' => array( 'stock', 'gold' ),
		...
		$elem->add_control(
			'pa_neg_change_color',
			array(
				'label'     => __( 'Negative Change Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$elem->add_control(
			'pa_pos_change_color',
			array(
				'label'     => __( 'Positive Change Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$elem->add_responsive_control(
			...
			array(
				'label'      => __( 'Icon Margin', 'premium-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px' ),
				'selectors'  => array(
	...
	public function pa_weather_options() {
		...
		$options = array(
			'source'                 => array(
				'name'   => __( 'City Name', 'premium-addons-pro' ),
				'coords' => __( 'City Coordinates', 'premium-addons-pro' ),
			),
			'layouts'                => array(
				'layout-1' => __( 'Layout 1', 'premium-addons-pro' ),
				'layout-2' => __( 'Layout 2', 'premium-addons-pro' ),
	...
	public function add_weather_source_controls( $elem ) {
		...
		$elem->add_control(
			'lat_coord',
			array(
				'label'       => __( 'Latitude', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
		...
		$elem->add_control(
			'long_coord',
			array(
				'label'       => __( 'Longitude', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
	...
	public function add_weather_dailyf_controls( $elem ) {
		...
		$elem->add_control(
			'forecast_layouts',
			array(
				'label'        => __( 'Choose Style', 'premium-addons-pro' ),
				'type'         => Controls_Manager::SELECT,
				'prefix_class' => 'premium-daily-forecast__',
				'render_type'  => 'template',
				'label_block'  => true,
				'options'      => array(
					'style-1' => __( 'Style 1', 'premium-addons-pro' ),
					'style-2' => __( 'Style 2', 'premium-addons-pro' ),
					'style-3' => __( 'Style 3', 'premium-addons-pro' ),
					'style-4' => __( 'Style 4', 'premium-addons-pro' ),
				),
				'default'      => 'style-1',
				'conditions'   => array(
					'terms' => array(
		...
		$elem->add_control(
			'show_forecast_icon',
			array(
				'label'     => __( 'Weather state Icon', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
		...
		$elem->add_control(
			'forecast_days',
			array(
				'label'       => __( 'Number Of Days', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SELECT,
				'render_type' => 'template',
				'label_block' => true,
				'options'     => array(
					'1' => __( '1 Day', 'premium-addons-pro' ),
					'2' => __( '2 Days', 'premium-addons-pro' ),
					'3' => __( '3 Days', 'premium-addons-pro' ),
					'4' => __( '4 Days', 'premium-addons-pro' ),
					'5' => __( '5 Days', 'premium-addons-pro' ),
					'6' => __( '6 Days', 'premium-addons-pro' ),
					'7' => __( '7 Days', 'premium-addons-pro' ),
					'8' => __( '8 Days', 'premium-addons-pro' ),
				),
				'default'     => 5,
				'condition'   => array(
					'enable_forecast' => 'yes',
		...
		$elem->add_responsive_control(
			'forecast_alignment',
			array(
				'label'        => __( 'Block Alignment', 'premium-addons-pro' ),
				...
				'options'      => array(
					...
					'space-between' => array(
						'title' => __( 'Strech', 'premium-addons-pro' ),
		...
		$elem->add_responsive_control(
			...
			array(
				'label'      => __( 'Element Minimum Width', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'selectors'  => array(
					...
					'{{WRAPPER}}.premium-forecast-tabs-yes .premium-weather__forecast-tabs-wrapper .premium-weather__hourly-item > *,
		...
		$elem->add_control(
			'forecast_tabs',
			array(
				'label'        => __( 'Activate Tabs', 'premium-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'description'  => __( 'Display 5 days weather forecast data with 3-hour step', 'premium-addons-pro' ),
				'render_type'  => 'template',
		...
		$elem->add_control(
			...
			array(
				...
				'description'    => __( 'Use this to display specific dates', 'premium-addons-pro' ),
		...
		$elem->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'description' => __( 'Know more abour date format from ', 'premium-addons-pro' ) . '<a href="https://wordpress.org/documentation/article/customize-date-and-time-format/" target="_blank">here</a>',
				'default'     => 'F j',
				'condition'   => array(
					'enable_forecast' => 'yes',
					'forecast_days!'  => array( '1', '6', '7', '8' ),
		...
		$elem->add_control(
			'tabs_weather_data',
			array(
				'label'       => __( 'Weather Data', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SELECT2,
				'label_block' => true,
				'options'     => array(
					'temp'       => __( 'Temperature', 'premium-addons-pro' ),
					'desc'       => __( 'Description', 'premium-addons-pro' ),
					'desc_icon'  => __( 'Weather Icon', 'premium-addons-pro' ),
					'wind'       => __( 'Wind Speed', 'premium-addons-pro' ),
					'pressure'   => __( 'Pressure', 'premium-addons-pro' ),
					'humidity'   => __( 'Humidity', 'premium-addons-pro' ),
					'wind_dir'   => __( 'Wind Direction', 'premium-addons-pro' ),
					'feels_like' => __( 'Feels Like', 'premium-addons-pro' ),
				),
		...
		$elem->add_control(
			'tabs_hourly_max',
			array(
				'label'       => __( 'Max Number of Hours', 'premium-addons-pro' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => __( 'Set a maximum number of hours to display up to 8 hours/day', 'premium-addons-pro' ),
				'default'     => 8,
				'max'         => 8,
				'min'         => 1,
				'condition'   => array(
		...
		$elem->add_control(
			'date_notice',
			array(
				'label'       => __( 'Expire Message', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'description' => __( 'A message to show when no forecast data available for a chosen day.', 'premium-addons-pro' ),
		...
		$elem->add_control(
			...
			array(
				'label'        => __( 'Activate Carousel', 'premium-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'render_type'  => 'template',
		...
		$elem->add_responsive_control(
			...
			array(
				'label'     => __( 'Slides To Show', 'premium-addons-pro' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 4,
				'max'       => 8,
				'min'       => 1,
		...
		$elem->add_control(
			...
			array(
				'label'        => __( 'Show Arrows On Hover', 'premium-addons-pro' ),
	...
	public function add_weather_custom_icons_controls( $elem ) {
		...
		$elem->add_control(
			'icons_source',
			array(
				'label'     => __( 'Icons Type', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'default' => __( 'Lottie Icons', 'premium-addons-pro' ),
					'custom'  => __( 'Upload Your Own', 'premium-addons-pro' ),
				),
				'default'   => 'default',
				'condition' => array(
		...
		$elem->add_control(
			...
			array(
				...
				'render_type' => 'template',
				'options'     => array(
					'filled'   => __( 'Filled', 'premium-addons-pro' ),
					'outlined' => __( 'Outlined', 'premium-addons-pro' ),
				),
				'default'     => 'filled',
				'condition'   => array(
					'enable_custom_icon' => 'yes',
		...
		$repeater->add_control(
			'weather_desc',
			array(
				'label'   => __( 'Weather Condition', 'premium-addons-pro' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'Clear Sky'        => __( 'Clear Sky', 'premium-addons-pro' ),
					'Few Clouds'       => __( 'Few Clouds', 'premium-addons-pro' ),
					'Scattered Clouds' => __( 'Scattered Clouds', 'premium-addons-pro' ),
					'Broken Clouds'    => __( 'Broken Clouds', 'premium-addons-pro' ),
					'Shower Rain'      => __( 'Shower Rain', 'premium-addons-pro' ),
					'Rain'             => __( 'Rain', 'premium-addons-pro' ),
					'Thunderstorm'     => __( 'Thunderstorm', 'premium-addons-pro' ),
					'Snow'             => __( 'Snow', 'premium-addons-pro' ),
					'Mist'             => __( 'Mist', 'premium-addons-pro' ),
				),
				'default' => 'Clear Sky',
			)
		);
		...
		$repeater->add_control(
			'pa_custom_icon',
			array(
				'label'     => __( 'Day Icon', 'premium-addons-pro' ),
		...
		$repeater->add_control(
			...
			array(
				'label'     => __( 'Night Icon', 'premium-addons-pro' ),
				'type'      => Controls_Manager::ICONS,
				'default'   => array(
					'value'   => 'fas fa-cloud',
					'library' => 'solid',
		...
		$repeater->add_control(
			'pa_weather_img',
			array(
				'label'     => __( 'Day Image', 'premium-addons-pro' ),
				'type'      => Controls_Manager::MEDIA,
				'condition' => array(
					'pa_icon_type' => 'image',
				),
		...
		$repeater->add_control(
			...
			array(
				'label'     => __( 'Night Image', 'premium-addons-pro' ),
				'type'      => Controls_Manager::MEDIA,
				'condition' => array(
					'pa_icon_type' => 'image',
					'weather_desc' => array( 'Clear Sky', 'Few Clouds', 'Rain' ),
		...
		$repeater->add_control(
			'pa_lottie_url',
			array(
				'label'       => __( 'Day Icon JSON URL', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
		...
		$repeater->add_control(
			'pa_lottie_url_night',
			array(
				'label'       => __( 'Night Icon JSON URL', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
		...
		$elem->add_control(
			'custom_icons',
			array(
				'label'       => esc_html__( 'Icons List', 'premium-addons-pro' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $icons,
	...
	public function pa_pinterest_layouts() {
		...
		$options = array(
			'layouts' => array(
				'layout-1' => __( 'Card', 'premium-addons-pro' ),
				'layout-2' => __( 'Banner', 'premium-addons-pro' ),
				'layout-3' => __( 'On Side', 'premium-addons-pro' ),
				'layout-4' => __( 'Slide', 'premium-addons-pro' ),
			),
		);
	...
	public function add_pinterest_board_controls( $elem ) {
		...
		$elem->start_controls_section(
			...
			array(
				'label'     => __( 'Board Settings', 'premium-addons-pro' ),
				'condition' => array(
					'show_feed' => 'yes',
					'endpoint'  => 'boards/',
				),
		...
		$elem->add_control(
			...
			array(
				...
				'options'      => array(
					'layout-cover' => __( 'Cover Image', 'premium-addons-pro' ),
					'layout-2'     => __( 'Collage 1', 'premium-addons-pro' ),
					'layout-3'     => __( 'Collage 2', 'premium-addons-pro' ),
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				'label'     => __( 'Pinterest Icon', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => __( 'Show', 'premium-addons-pro' ),
				'label_off' => __( 'Hide', 'premium-addons-pro' ),
			)
		...
		$elem->add_control(
			'board_pin_count',
			array(
				'label'     => __( 'Pin Count', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => __( 'Show', 'premium-addons-pro' ),
				'label_off' => __( 'Hide', 'premium-addons-pro' ),
				'separator' => 'before',
		...
		$elem->add_control(
			'board_desc_len',
			array(
				'label'     => __( 'Description Length (Word)', 'premium-addons-pro' ),
				'type'      => Controls_Manager::NUMBER,
				'condition' => array(
					'pin_desc' => 'yes',
				),
		...
		$elem->add_control(
			'board_desc_postfix',
			array(
				'label'       => __( 'Postfix', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
		...
		$elem->add_responsive_control(
			'board_desc_order',
			array(
				'label'     => __( 'Description Order', 'premium-addons-pro' ),
				'type'      => Controls_Manager::CHOOSE,
				'toggle'    => false,
				'options'   => array(
					'1' => array(
						'title' => __( 'Before Pin Count', 'premium-addons-pro' ),
						'icon'  => 'eicon-order-start',
					),
					'2' => array(
						'title' => __( 'After Pin Count', 'premium-addons-pro' ),
		...
		$elem->add_responsive_control(
			'board_width',
			array(
				'label'      => __( 'Board Width', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
		...
		$elem->add_responsive_control(
			...
			array(
				'label'     => __( 'Container Alignment', 'premium-addons-pro' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => array(
					'flex-start' => array(
	...
	public function add_image_hover_effects( $elem ) {
		...
		$elem->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::SELECT,
				'description' => __( 'Choose a hover effect for the image', 'premium-addons-pro' ),
				'options'     => array(
	...
	public function add_pinterest_board_style( $elem ) {
		...
		$elem->start_controls_section(
			...
			array(
				'label'     => __( 'Board', 'premium-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'show_feed' => 'yes',
					'endpoint'  => 'boards/',
		...
		$elem->add_control(
			'board_media_heading',
			array(
				'label'     => __( 'Cover', 'premium-addons-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
	...
	public function add_pinterest_profile_controls( $elem ) {
		...
		$elem->add_control(
			'avatar_url',
			array(
				'label'     => __( 'Profile Picture', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => __( 'Show', 'premium-addons-pro' ),
				'label_off' => __( 'Hide', 'premium-addons-pro' ),
				'default'   => 'yes',
		...
		$elem->add_control(
			'bio_description',
			array(
				'label'     => __( 'Biography', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => __( 'Show', 'premium-addons-pro' ),
				'label_off' => __( 'Hide', 'premium-addons-pro' ),
				'separator' => 'before',
		...
		$elem->add_control(
			'following_count',
			array(
				'label'     => __( 'Following Count', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => __( 'Show', 'premium-addons-pro' ),
				'label_off' => __( 'Hide', 'premium-addons-pro' ),
				'default'   => 'yes',
		...
		$elem->add_control(
			'follower_count',
			array(
				'label'     => __( 'Follower Count', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => __( 'Show', 'premium-addons-pro' ),
				'label_off' => __( 'Hide', 'premium-addons-pro' ),
				'default'   => 'yes',
		...
		$elem->add_control(
			'view_count',
			array(
				'label'     => __( 'Monthly Views Count', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => __( 'Show', 'premium-addons-pro' ),
				'label_off' => __( 'Hide', 'premium-addons-pro' ),
				'default'   => 'yes',
		...
		$elem->add_responsive_control(
			'bio_align',
			array(
				'label'     => __( 'Biography Alignment', 'premium-addons-pro' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => array(
					'left'   => array(
						'title' => __( 'Left', 'premium-addons-pro' ),
		...
		$elem->add_responsive_control(
			'profile_bio_order',
			array(
				'label'     => __( 'Biography Order', 'premium-addons-pro' ),
				'type'      => Controls_Manager::CHOOSE,
				'toggle'    => false,
				'options'   => array(
					'2' => array(
						'title' => __( 'Before Counts', 'premium-addons-pro' ),
						'icon'  => 'eicon-order-start',
					),
					'1' => array(
						'title' => __( 'After Counts', 'premium-addons-pro' ),
						'icon'  => 'eicon-order-end',
					),
				),
				'default'   => '1',
		...
		$elem->add_responsive_control(
			'counts_align',
			array(
				'label'      => __( 'Counts Alignment', 'premium-addons-pro' ),
				'type'       => Controls_Manager::CHOOSE,
				'options'    => array(
					'flex-start'    => array(
						'title' => __( 'Left', 'premium-addons-pro' ),
	...
	public function add_pinterest_profile_style( $elem ) {
		...
		$elem->add_control(
			'pa_counters_heading',
			array(
				'label'      => __( 'Counters', 'premium-addons-pro' ),
				'type'       => Controls_Manager::HEADING,
				'separator'  => 'before',
		...
		$elem->add_responsive_control(
			'counts_spacing',
			array(
				'label'      => __( 'Inner Spacing', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'selectors'  => array(
	...
	public function add_pinterest_slide_align( $elem ) {
		...
		$elem->add_responsive_control(
			...
			array(
				'label'       => __( 'Bottom Offset', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SLIDER,
				'size_units'  => array( 'px', '%', 'custom' ),
				'range'       => array(
					'px' => array(
	...
	public function add_pinterest_dots_style( $elem ) {
		...
		$elem->add_responsive_control(
			'pinterest_dots_size',
			array(
				'label'      => __( 'Dots Size', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'separator'  => 'before',
				'selectors'  => array(
		...
		$elem->add_responsive_control(
			...
			array(
				'label'      => __( 'Dots Spacing', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'separator'  => 'after',
				'selectors'  => array(
	...
	public function add_tiktok_profile_controls( $elem ) {
		...
		$elem->add_control(
			'is_verified',
			array(
				'label'       => __( 'Verify Icon', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __( 'Shows the Verified Icon only if the account is verified.', 'premium-addons-pro' ),
				'label_on'    => __( 'Show', 'premium-addons-pro' ),
				'label_off'   => __( 'Hide', 'premium-addons-pro' ),
				'default'     => 'yes',
				'condition'   => array(
		...
		$elem->add_control(
			'likes_count',
			array(
				'label'     => __( 'Likes Count', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => __( 'Show', 'premium-addons-pro' ),
				'label_off' => __( 'Hide', 'premium-addons-pro' ),
				'default'   => 'yes',
	...
	public function add_tiktok_profile_style( $elem ) {
		...
		$elem->add_control(
			...
			array(
				'label'     => __( 'Verified Icon Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#4DD0E1',
				'selectors' => array(
	...
	public function add_tiktok_loadmore_options( $elem ) {
		...
		$elem->add_control(
			'no_per_load',
			array(
				'label'       => __( 'videos On Load More', 'premium-addons-pro' ),
				'description' => __( 'Number of videos to load', 'premium-addons-pro' ),
				'type'        => Controls_Manager::NUMBER,
				'default'     => 3,
				'condition'   => array(
					'carousel!'     => 'yes',
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::TEXT,
				'default'   => __( 'Load More', 'premium-addons-pro' ),
				'condition' => array(
					'carousel!'     => 'yes',
					'load_more_btn' => 'yes',
				),
	...
	public function add_tiktok_loadmore_style( $elem ) {
		...
		$elem->start_controls_section(
			'cta_style_section',
			array(
				'label'     => __( 'CTA Button', 'premium-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'show_feed'     => 'yes',
					'load_more_btn' => 'yes',
	...
	public function add_tooltips_type_controls( $elem ) {
		...
		$elem->add_control(
			...
			array(
				'label'       => __( 'Gallery', 'premium-addons-pro' ),
				'type'        => Controls_Manager::GALLERY,
				'description' => __( 'Set multiple images for random image selection.', 'premium-addons-pro' ),
				'render_type' => 'template',
				'condition'   => array(
		...
		$elem->add_control(
			...
			array(
				'raw'             => __( '<strong>Please Note!: In the Editor/backend only</strong> Elementor Templates are loaded via AJAX. So, it might take a bit to show up.</li></ul>', 'premium-addons-pro' ),
				'type'            => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
				'condition'       => array(
					'premium_tooltip_switcher' => 'yes',
		...
		$elem->add_control(
			'pa_tooltip_class',
			array(
				'label'       => __( 'CSS Navigation Selector', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'description' => __( 'This can be used to navigate to this tooltip by adding the same class from widget settings -> Advanced tab -> CSS classes. <b>Important: the class must start with "tooltip-"</b>', 'premium-addons-pro' ),
				'dynamic'     => array(
					'active' => true,
				),
				'condition'   => array(
		...
		$elem->add_control(
			'is_tour_starter',
			array(
				'label'       => __( 'First Step in The Tour?', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __( 'Enable if this tooltip is the first step in the user\'s tour|guide you\'re creating.', 'premium-addons-pro' ),
				'render_type' => 'template',
				'condition'   => array(
					'premium_tooltip_switcher' => 'yes',
					'pa_tooltip_class!'        => '',
	...
	public function add_cf_presets_controls( $elem ) {
		...
		$elem->add_control(
			...
			array(
				'type'        => Controls_Manager::RAW_HTML,
				'raw'         => '<form onsubmit="createCfForm(this);" action="javascript:void(0);"><input type="submit" value="Create & Insert Form" class="elementor-button" style="background-color: #252c59; color: #fff;"></form>',
				'label_block' => true,
				'condition'   => array(
					'source' => 'presets',
				),
		...
		$elem->add_control(
			'form_id',
			array(
				'label'     => __( 'Form ID', 'premium-addons-pro' ),
				'type'      => Controls_Manager::TEXT,
	...
	public function add_cf_effects_controls( $elem ) {
		...
		$elem->add_responsive_control(
			'labels_pos',
			array(
				'label'     => __( 'Label Position (PX)', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SLIDER,
				'selectors' => array(
		...
		$elem->add_responsive_control(
			'labels_focus_pos',
			array(
				'label'     => __( 'Label Focus Position (PX)', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SLIDER,
				'selectors' => array(
		...
		$elem->add_control(
			...
			array(
				'label'     => __( 'Focus Background Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$elem->add_group_control(
			...
			array(
				...
				'label'     => __( 'Focus CSS Filters', 'premium-addons-pro' ),
		...
		$elem->add_control(
			'fields_focus_line',
			array(
				'label'        => __( 'Focus Line Animation', 'premium-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$elem->add_control(
			'focus_line_middle',
			array(
				'label'        => __( 'Animate From Middle', 'premium-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$elem->add_control(
			'focus_line_color',
			array(
				'label'     => __( 'Focus Line Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
	...
	public function add_adv_carousel_controls( $elem ) {
		...
		$elem->add_control(
			...
			array(
				'label'        => __( 'Gradual Scale Effect', 'premium-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$elem->add_responsive_control(
			...
			array(
				'label'       => __( 'Spacing', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SLIDER,
				'description' => __( 'Space between items relative to each item\'s width. 0 for no spacing, negative values to overlap', 'premium-addons-pro' ),
				'size_units'  => array( 'px' ),
				'range'       => array(
					'px' => array(
						'min'  => -5,
		...
		$elem->add_control(
			...
			array(
				'label'     => __( 'Auto Play Speed (ms)', 'premium-addons-pro' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 3000,
				'condition' => array(
					'media_wheel_animation!' => 'infinite',
		...
		$elem->add_control(
			'nav_on_click',
			array(
				'label'       => __( 'Scroll on Click', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __( 'Clicking an item switches to that item', 'premium-addons-pro' ),
				'default'     => 'yes',
				'condition'   => array(
					'media_wheel_animation!' => 'infinite',
				),
		...
		$elem->add_control(
			'nav_by_keyboard',
			array(
				'label'       => __( 'Scroll By Keyboard', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __( 'Enable left/right arrow navigation', 'premium-addons-pro' ),
				'condition'   => array(
					'media_wheel_animation!' => 'infinite',
				),
			)
		...
		$elem->add_control(
			'nav_by_touch',
			array(
				'label'       => __( 'Scoll By Touch on Small Devices', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __( 'Enable swipe navigation for touch devices', 'premium-addons-pro' ),
				'condition'   => array(
					'media_wheel_animation!' => 'infinite',
				),
			)
	...
	public function add_adv_carousel_effects_navigation( $elem ) {
		...
		$elem->add_control(
			'prev_arrow',
			array(
				'label'       => __( 'Previous Icon', 'premium-addons-pro' ),
				'type'        => Controls_Manager::ICONS,
				'label_block' => false,
				'skin'        => 'inline',
				'default'     => array(
		...
		$elem->add_control(
			'next_arrow',
			array(
				'label'       => __( 'Next Icon', 'premium-addons-pro' ),
				'type'        => Controls_Manager::ICONS,
				'label_block' => false,
				'skin'        => 'inline',
				'default'     => array(
	...
	public function add_testimonials_skins_controls( $elem ) {
		...
		$elem->add_control(
			...
			array(
				...
				'options'     => array(
					'row'         => array(
						'title' => __( 'Before Info', 'premium-addons-pro' ),
						'icon'  => 'eicon-flex eicon-align-end-v premium-rotate-icon',
					),
					'row-reverse' => array(
						'title' => __( 'After Info', 'premium-addons-pro' ),
		...
		$elem->add_control(
			...
			array(
				...
				'options'              => array(
					'top'    => array(
						'title' => __( 'Above Text', 'premium-addons-pro' ),
						'icon'  => 'eicon-flex eicon-justify-start-h premium-rotate-icon',
					),
					'bottom' => array(
						'title' => __( 'Below Text', 'premium-addons-pro' ),
	...
	public function add_shape_divider_svg( $element ) {
		...
		$element->add_control(
			...
			array(
				...
				'description' => __( 'Enter you SVG code here. You can get Free Shape Dividers ', 'premium-addons-pro' ) . '<a href="https://www.dezign4fun.com/free-shape-dividers/" target="_blank">here</a>' . __( ', Or get cool waves through ', 'premium-addons-pro' ) . '<a href="https://svgwave.in/" target="_blank">SVG Waves, </a><a href="https://getwaves.io/" target="_blank">Waves.io, </a><a href="https://wavelry.vercel.app/" target="_blank">Waverly</a>',
				'label_block' => true,
				'render_type' => 'template',
				'condition'   => array(
	...
	public function add_button_hover_controls( $elem, $conditions ) {
		...
		$elem->add_control(
			'underline_style',
			array(
				'label'       => __( 'Underline Style', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'line1',
				'options'     => array(
					'line1' => __( 'Style 1', 'premium-addons-pro' ),
					'line2' => __( 'Style 2', 'premium-addons-pro' ),
					'line3' => __( 'Style 3', 'premium-addons-pro' ),
					'line4' => __( 'Style 4', 'premium-addons-pro' ),
					'line5' => __( 'Style 5', 'premium-addons-pro' ),
					'line6' => __( 'Style 6', 'premium-addons-pro' ),
					'line7' => __( 'Style 7', 'premium-addons-pro' ),
				),
		...
		$elem->add_responsive_control(
			'line_width',
			array(
				'label'     => __( 'Line Width (%)', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => array(
					'size' => 100,
				),
		...
		$elem->add_responsive_control(
			'line_h_position',
			array(
				'label'     => __( 'Line Horizontal Position (%)', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SLIDER,
				'condition' => array_merge(
					$conditions,
					array(
		...
		$elem->add_control(
			...
			array(
				'label'       => __( 'Slide Direction', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'bottom',
				'options'     => array(
					'top'    => __( 'Bottom to Top', 'premium-addons-pro' ),
					'bottom' => __( 'Top to Bottom', 'premium-addons-pro' ),
		...
		$elem->add_control(
			...
			array(
				...
				'default'     => 'radialin',
				'options'     => array(
					'radialin'  => __( 'Radial In', 'premium-addons-pro' ),
					'radialout' => __( 'Radial Out', 'premium-addons-pro' ),
					'rectin'    => __( 'Rectangle In', 'premium-addons-pro' ),
					'rectout'   => __( 'Rectangle Out', 'premium-addons-pro' ),
				),
				'condition'   => array_merge(
					$conditions,
					array(
		...
		$elem->add_responsive_control(
			'grow_size',
			array(
				'label'     => __( 'Grow Layer Size', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min' => 0,
		...
		$elem->add_control(
			'grow_speed',
			array(
				'label'     => __( 'Grow Animation Speed (Sec)', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 0,
		...
		$elem->add_control(
			'mouse_detect',
			array(
				'label'        => __( 'Detect Mouse Position', 'premium-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
	 ...
	 * @param object $elem elementor element.
	 */
	public function add_showcase_clip_scroll( $elem ) {

		$elem->add_control(
			'clip_scroll_heading',
			array(
				'label' => __( 'Clip on Scroll Effect Settings', 'premium-addons-pro' ),
				'type'  => Controls_Manager::HEADING,
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'default'      => 'play',
				'render_type'  => 'template',
				'prefix_class' => 'premium-showcase-clip__',
				'label_block'  => true,
			)
		);

		$elem->add_control(
			'clip_behavior_notice',
			array(
				'raw'             => __( 'You may need to click the Apply button above after changing this option.', 'premium-addons-pro' ),
				'type'            => Controls_Manager::RAW_HTML,
		...
		$elem->add_control(
			'clip_sync',
			array(
				'label'       => __( 'Sync Animation', 'premium-addons-pro' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __( 'Enable this option to apply clip effect on all texts at the same time.', 'premium-addons-pro' ),
				'selectors'   => array(
					'{{WRAPPER}}' => '--pa-clip-sync: {{SIZE}}',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => '--pa-clip-speed: {{SIZE}}',
				),
			)
		);

		$elem->add_control(
			'clip_scroll_trigger_offset',
			array(
		...
		// $elem->add_control(
		// 'clip_scroll_viewport_end',
		// array(
		// 'label'     => __( 'Viewport End', 'premium-addons-pro' ),
		// 'type'      => Controls_Manager::SLIDER,
		// 'default'   => array(
		// 'size' => 100,
		// ),
		// 'selectors' => array(
		// '{{WRAPPER}}' => '--pa-clip-viewport-end: {{SIZE}}',
		// ),
		// )
		// );
	}
	 ...
	 * @return array $layouts widget layouts.
	 */
	public function pa_countdown_options() {

		$options = array(
			'styles'          => array(
				'default'  => __( 'Default', 'premium-addons-pro' ),
				'featured' => __( 'Featured Unit', 'premium-addons-pro' ),
				'circle'   => __( 'Circle', 'premium-addons-pro' ),
				'rotate'   => __( 'Rotate', 'premium-addons-pro' ),
				'flipping' => __( 'Flip', 'premium-addons-pro' ),
			),
			'style_condition' => '',
		);
	 ...
	 * @param object $elem elementor element.
	 */
	public function add_search_effects_options( $elem ) {
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => array(
					'{{WRAPPER}} .premium-search__label' => 'transform: translateX(10px) translateY({{SIZE}}{{UNIT}})',
				),
				'condition' => array(
					'show_label'    => 'yes',
					'field_effects' => array( 'label', 'label-pos-back' ),
				),
			)
		);
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => array(
					'{{WRAPPER}} .is-focused .premium-seach__label' => 'transform: translateX(10px) translateY({{SIZE}}{{UNIT}}) !important',
				),
				'condition' => array(
					'show_label'    => 'yes',
					'field_effects' => 'label-pos-back',
				),
			)
		);

		$elem->add_control(
			'label_focus_back_color',
			array(
				'label'     => __( 'Focus Background Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .is-focused .premium-search__label' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'show_label'    => 'yes',
					'field_effects' => 'label-pos-back',
		...
		$elem->add_group_control(
			Group_Control_Css_Filter::get_type(),
			array(
				'name'      => 'label_css_filters',
				'selector'  => '{{WRAPPER}} .premium-search__label',
				'condition' => array(
					'show_label'    => 'yes',
					'field_effects' => 'css-filters',
				),
			)
		);
		...
		$elem->add_group_control(
			Group_Control_Css_Filter::get_type(),
			array(
				'name'      => 'label_focus_css_filters',
				'label'     => __( 'Focus CSS Filters', 'premium-addons-pro' ),
				'selector'  => '{{WRAPPER}} .is-focused .premium-search__label',
				'condition' => array(
					'show_label'    => 'yes',
					'field_effects' => 'css-filters',
				),
		...
		$elem->add_control(
			...
			array(
				'label'        => __( 'Animate From Middle', 'premium-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'prefix_class' => 'premium-search-anim-middle-',
				'condition'    => array(
					'field_focus_line' => 'yes',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .is-focused .premium-search__input-wrap::after' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'field_focus_line' => 'yes',
				),
	...
	/**
	 * Add Keyword Remove Button Style
	 *
	 * @since 2.9.15
	 * @access public
	 *
	 * @param object $elem elementor element.
	 */
	public function add_keyword_remove_button_style( $elem ) {

		$elem->start_controls_section(
			'remove_keyword_style',
			array(
				'label'     => __( 'Remove Keyword Button', 'premium-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
		...
		$elem->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-search__remove-icon' => 'font-size: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-search__remove-wrap' => 'right: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-search__remove-icon'     => 'color: {{VALUE}};',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-search__remove-icon:hover'     => 'color: {{VALUE}};',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-search__remove-icon'     => 'background-color: {{VALUE}};',
				),
			)
		);

		$elem->add_control(
			'remove_button_hover_background',
			array(
				'label'     => __( 'Hover Background Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-search__remove-icon:hover'     => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$elem->add_group_control(
			Group_Control_Border::get_type(),
			array(
				'name'     => 'remove_btn_border',
				'selector' => '{{WRAPPER}} .premium-search__remove-icon',
			)
		);

		$elem->add_control(
			'remove_btn_border_radius',
			array(
				'label'      => __( 'Border Radius', 'premium-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-search__remove-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elem->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			array(
				'name'     => 'remove_btn_box_shadow',
				'selector' => '{{WRAPPER}} .premium-search__remove-wrap',
			)
		);
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-search__remove-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
	 ...
	 * @param object $elem elementor element.
	 */
	public function add_select_field_style( $elem ) {

		$elem->start_controls_section(
			'select_field_style',
			array(
				'label'     => __( 'Select Field', 'premium-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'query_type'           => 'post',
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .premium-search__type-select' => 'width: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-search__type-select' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elem->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .premium-search__type-select',
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-search__type-select' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$elem->add_responsive_control(
			'select_text_indent',
			array(
				'label'      => __( 'Text Indent', 'premium-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', 'em', '%', 'custom' ),
				'range'      => array(
					'px' => array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .premium-search__type-select' => 'text-indent: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-search__type-select' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-search__type-filter' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
	...
	/**
	 * Add Mobile Menu badge controls
	 *
	 * @since 2.9.17
	 * @access public
	 *
	 * @param object $elem repeater element.
	 */
	public function add_mobile_menu_badge_controls( $elem ) {

		$elem->add_control(
			'badge_title',
			array(
				'label'     => __( 'Badge Text', 'premium-addons-pro' ),
				'type'      => Controls_Manager::TEXT,
				'condition' => array(
					'show_badge' => 'yes',
				),
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .premium-mobile-menu__badge'    => 'right: {{SIZE}}{{UNIT}}',
				),
				'condition'  => array(
					'show_badge' => 'yes',
				),
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .premium-mobile-menu__badge'    => 'top: {{SIZE}}{{UNIT}}',
				),
				'condition'  => array(
					'show_badge' => 'yes',
				),
	...
	/**
	 * Add Mobile Menu carousel controls
	 *
	 * @since 2.9.17
	 * @access public
	 *
	 ...
	 */
	public function add_mobile_menu_carousel_controls( $elem ) {

		$elem->add_responsive_control(
			'items_to_show',
			array(
				'label'              => __( 'Items to Show', 'premium-addons-pro' ),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 3,
				'condition'          => array(
					'carousel' => 'yes',
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} a.carousel-arrow.carousel-next' => 'right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} a.carousel-arrow.carousel-prev' => 'left: {{SIZE}}{{UNIT}};',
				),
			)
		);
	}
	 ...
	 * @param object $elem repeater element.
	 */
	public function add_mobile_menu_badge_style( $elem ) {

		$elem->add_control(
			'badge_text_color',
			array(
				'label'     => __( 'Badge Text Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .premium-mobile-menu__badge span' => 'color: {{VALUE}}',
				),
				'condition' => array(
					'show_badge' => 'yes',
				),
		...
		$elem->add_control(
			...
			array(
				'label'     => __( 'Badge Background', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .premium-mobile-menu__badge span' => 'background-color: {{VALUE}}',
				),
				'condition' => array(
					'show_badge' => 'yes',
				),
	...
	/**
	 * Add Mobile Menu badge style tab
	 *
	 * @since 2.9.17
	 * @access public
	 *
	 * @param object $elem element.
	 */
	public function add_mobile_menu_badge_style_tab( $elem ) {

		$elem->start_controls_section(
			'items_badge_style',
			array(
				'label' => __( 'Item Badge', 'premium-addons-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-mobile-menu__badge span' => 'color: {{VALUE}};',
				),
			)
		);

		$elem->add_control(
			'menu_badge_hover_color',
			array(
				'label'     => __( 'Hover Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-mobile-menu__link:hover .premium-mobile-menu__badge span' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$elem->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .premium-mobile-menu__badge span',
			)
		);

		$elem->add_control(
			'menu_badge_back_color',
			array(
				'label'     => __( 'Background Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-mobile-menu__badge span' => 'background-color: {{VALUE}};',
				),
			)
		);

		$elem->add_control(
			'menu_badge_hover_back_color',
			array(
				'label'     => __( 'Background Hover Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-mobile-menu__link:hover .premium-mobile-menu__badge span' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-mobile-menu__badge span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				),
			)
		);
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-mobile-menu__badge span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				),
			)
		);
	...
	/**
	 * Add Mobile Menu indicator style tab
	 *
	 * @since 2.9.17
	 * @access public
	 *
	 * @param object $elem element.
	 */
	public function add_mobile_menu_indicator_carousel_style( $elem ) {

		$elem->start_controls_section(
			'active_item_indicator_style',
			array(
				'label'     => __( 'Active Item Indicator', 'premium-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'active_item_indicator' => 'yes',
				),
			)
		);
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'custom' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-mobile-menu__link::after' => 'top: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-mobile-menu__link::after' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-mobile-menu__link:hover::after' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', 'custom' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-mobile-menu__link::after' => 'width: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', 'custom' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-mobile-menu__link::after' => 'height: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-mobile-menu__link::after' => 'border-radius: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .slick-arrow' => 'padding: {{SIZE}}{{UNIT}};',
				),
			)
		);
	 ...
	 * @param object $elem element.
	 */
	public function add_atext_highlight_controls( $elem ) {
		...
		$elem->add_control(
			...
			array(
				...
				'options'     => array(
					'circle'    => __( 'Circle', 'premium-addons-pro' ),
					'wavy'      => __( 'Wavy Zigzag', 'premium-addons-pro' ),
					'underline' => __( 'Underline', 'premium-addons-pro' ),
					'double'    => __( 'Double Underline', 'premium-addons-pro' ),
					'zigzag'    => __( 'Underline Zigzag', 'premium-addons-pro' ),
					'strike'    => __( 'Strikethrough', 'premium-addons-pro' ),
					'cross'     => __( 'Cross X', 'premium-addons-pro' ),
				),
				'default'     => 'circle',
				'label_block' => true,
				'condition'   => array(
		...
		$elem->add_control(
			'reveal_notice',
			array(
				'raw'             => __( 'To see this effect, you need to set background color from Style tab.', 'premium-addons-pro' ),
				'type'            => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
				'condition'       => array(
					'style'            => 'highlight',
		...
		$elem->add_control(
			'lines_notice',
			array(
				'raw'             => __( 'You need to set colors for this effect from style tab.', 'premium-addons-pro' ),
				'type'            => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
				'condition'       => array(
					'style'            => 'highlight',
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .premium-atext__text' => 'width: {{SIZE}}{{UNIT}} !important',
				),
				'condition'  => array(
					'style'            => 'highlight',
					'highlight_effect' => 'lines',
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-atext__underline .premium-atext__text::after'    => 'bottom: {{SIZE}}{{UNIT}}',
				),
				'condition' => array(
					'style'            => 'highlight',
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .premium-atext__lines .premium-atext__text'    => 'height: {{SIZE}}{{UNIT}} !important',
					'{{WRAPPER}} .premium-atext__underline .premium-atext__text::after'    => 'height: {{SIZE}}{{UNIT}}',
				),
				'condition'  => array(
					'style'            => 'highlight',
					'highlight_effect' => array( 'lines', 'underline' ),
				),
			)
		);
	}
	...
	/**
	 * Add Animated Text Shape style tab
	 *
	 * @since 2.9.18
	 * @access public
	 *
	 * @param object $elem element.
	 */
	public function add_atext_shape_style( $elem ) {
		...
		$elem->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-atext__shape path' => 'stroke: {{VALUE}}',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .premium-atext__shape path' => 'stroke-width: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$elem->add_control(
			'rounded_edges',
			array(
				'label'     => __( 'Rounded Edges', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => array(
					'{{WRAPPER}} .premium-atext__shape path' => 'stroke-linecap: round; stroke-linejoin: round',
				),
			)
		);
	...
	/**
	 * Add Woo Categories Listing Carousel Options tab
	 *
	 * @since 2.9.19
	 * @access public
	 *
	 * @param object $elem element.
	 */
	public function add_woo_cats_carousel_controls( $elem ) {

		$elem->start_controls_section(
			'section_carousel_options',
			array(
				'label'     => __( 'Carousel Options', 'premium-addons-pro' ),
		...
		$elem->add_control(
			'arrows',
			array(
				'label'              => __( 'Show Arrows', 'premium-addons-pro' ),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => 'yes',
				'frontend_available' => true,
			)
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .premium-woo-cats__container a.carousel-arrow.carousel-next' => 'right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .premium-woo-cats__container a.carousel-arrow.carousel-prev' => 'left: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elem->add_control(
			'dots',
			array(
				'label'              => __( 'Show Dots', 'premium-addons-pro' ),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => 'yes',
				'frontend_available' => true,
			)
		...
		$elem->add_responsive_control(
			'products_to_scroll',
			array(
				'label'              => __( 'Products to Scroll', 'premium-addons-pro' ),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 1,
				'frontend_available' => true,
			)
		...
		$elem->add_control(
			'autoplay_slides',
			array(
				'label'              => __( 'Autoplay Slides', 'premium-addons-pro' ),
				'type'               => Controls_Manager::SWITCHER,
				'separator'          => 'before',
				'frontend_available' => true,
			)
		...
		$elem->add_control(
			'autoplay_speed',
			array(
				'label'              => __( 'Autoplay Interval', 'premium-addons-pro' ),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 3000,
				'condition'          => array(
					'autoplay_slides' => 'yes',
	...
	/**
	 * Add Woo Categories Listing Carousel Style tab
	 *
	 * @since 2.9.19
	 * @access public
	 *
	 * @param object $elem element.
	 */
	public function add_woo_cats_carousel_style( $elem ) {
		...
		$elem->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-woo-cats__container .slick-arrow' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-woo-cats__container .slick-arrow i' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-woo-cats__container .slick-arrow' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-woo-cats__container .slick-arrow' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-woo-cats__container .slick-arrow' => 'padding: {{SIZE}}{{UNIT}};',
				),
			)
		);
	...
	/**
	 * Add Woo Categories Listing Individual Style tab
	 *
	 * @since 2.9.19
	 * @access public
	 *
	 * @param object $elem element.
	 */
	public function add_woo_cats_individual_style( $elem ) {
		...
		$repeater->add_group_control(
			...
			array(
				'fields_options' => array(
					'border' => array(
						'label' => __( 'Hover Border Type', 'premium-addons-pro' ),
					),
				),
	 ...
	 * @param object $elem element.
	 */
	public function add_woo_cta_notice_controls( $elem ) {

		$elem->add_control(
			'important_notice_1',
			array(
				'raw'             => __(
					'WooCommerce wishlist button requires installing <a href="https://wordpress.org/plugins/yith-woocommerce-wishlist/" target="_blank" rel="noopener noreferrer">YITH</a> or <a href="https://moreconvert.com/product/wishlist/" target="_blank" rel="noopener noreferrer">MC</a> WordPress plugins.',
					'premium-addons-pro'
				),
				'type'            => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
				'condition'       => array(
					'button_action' => array( 'add_to_wishlist' ),
				),
			)
		);
		...
		$elem->add_control(
			...
			array(
				'raw'             => __(
					'WooCommerce Add to Compare requires installing <a href="https://wordpress.org/plugins/yith-woocommerce-compare/" target="_blank" rel="noopener noreferrer">YITH</a> or <a href="https://wordpress.org/plugins/ever-compare/" target="_blank" rel="noopener noreferrer">Ever Compare</a> WordPress plugins.',
					'premium-addons-pro'
				),
				'type'            => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
				'condition'       => array(
					'button_action' => array( 'add_to_compare' ),
				),
			)
		);
	}
	 ...
	 * @param object $elem element.
	 */
	public function add_woo_cta_text_controls( $elem ) {

		$elem->add_control(
			'wishlist_button_text',
			array(
				'label'       => __( 'Text', 'premium-addons-pro' ),
				'default'     => __( 'Add to Wishlist', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
		...
		$elem->add_control(
			'wishlist_message',
			array(
				'label'       => __( 'Added to Wishlist Message', 'premium-addons-pro' ),
				'default'     => __( 'Product added!', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
		...
		$elem->add_control(
			'wishlist_remove_text',
			array(
				'label'       => __( 'Remove Message', 'premium-addons-pro' ),
				'default'     => __( 'Remove From Wishlist', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
		...
		$elem->add_control(
			...
			array(
				'label'       => __( 'Text', 'premium-addons-pro' ),
				'default'     => __( 'Add to Compare', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
		...
		$elem->add_control(
			'compare_remove_text',
			array(
				'label'       => __( 'Remove Text', 'premium-addons-pro' ),
				'default'     => __( 'Remove From Compare', 'premium-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
	...
	/**
	 * Add Woo Mini Cart Window Controls
	 *
	 * @since 2.9.22
	 * @access public
	 *
	 * @param object $elem element.
	 */
	public function add_woo_mini_cart_window_controls( $elem ) {

		$elem->add_control(
			'trigger',
			array(
				'label'     => __( 'Trigger On', 'premium-addons-pro' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
		...
		$elem->add_control(
			...
			array(
				...
				'options'      => array(
					'none'        => __( 'None', 'premium-addons-pro' ),
					'slide-up'    => __( 'Slide Up', 'premium-addons-pro' ),
					'slide-down'  => __( 'Slide Down', 'premium-addons-pro' ),
					'slide-left'  => __( 'Slide Left', 'premium-addons-pro' ),
					'slide-right' => __( 'Slide Right', 'premium-addons-pro' ),
				),
				'condition'    => array(
					'behaviour' => 'toggle',
					'cart_type' => 'menu',
		...
		$elem->add_responsive_control(
			'mini_window_pos',
			array(
				'label'        => __( 'Mini Window Position', 'premium-addons-pro' ),
				'type'         => Controls_Manager::CHOOSE,
				'prefix_class' => 'pa-woo-mc__mw-',
				'options'      => array(
					'left'   => array(
						'title' => __( 'Left', 'premium-addons-pro' ),
						'icon'  => 'eicon-h-align-left',
	...
	/**
	 * Add Woo Mini Cart Window Style Controls
	 *
	 * @since 2.9.22
	 * @access public
	 *
	 * @param object $elem element.
	 */
	public function add_woo_mini_cart_window_style_controls( $elem ) {

		$elem->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			array(
				'name'      => 'outer_cont_shadow',
				'separator' => 'before',
		...
		$elem->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .pa-woo-mc__content-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition'  => array(
					'behaviour' => 'toggle',
					'cart_type' => 'menu',
