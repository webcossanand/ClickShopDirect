...
class Premium_Content_Toggle extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'pa', 'premium', 'premium content switcher', 'toggle' );
	}
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_responsive_control(
			...
			array(
                ...
                'size_units' => array( 'px', 'em' ),
				'selectors' => array(
					'{{WRAPPER}} .premium-content-toggle-switcher' => 'gap: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .premium-content-toggle__first-label',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Active Text Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'global'    => array(
					'default' => Global_Colors::COLOR_SECONDARY,
				),
				'selectors' => array(
					'{{WRAPPER}} .premium-content-toggle__first-label' => 'color: {{VALUE}};',
				),
			)
		);

		$this->add_control(
			'inactive_first_label_color',
			array(
				'label'     => __( 'Inactive Text Color', 'premium-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'global'    => array(
					'default' => Global_Colors::COLOR_SECONDARY,
				),
				'selectors' => array(
					'{{WRAPPER}} .premium-content-toggle__first-label:not(.premium-content-toggle__active-text)' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-content-toggle__first-label' => 'background: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-content-toggle__first-label' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-content-toggle__first-label' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .premium-content-toggle__second-label',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-content-toggle__second-label' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-content-toggle__second-label:not(.premium-content-toggle__active-text)' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-content-toggle__second-label' => 'background: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-content-toggle__second-label' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-content-toggle__second-label' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'premium_content_toggle_heading_one', 'class', array( 'premium-content-toggle__first-label', 'premium-content-toggle__active-text' ) );

		$this->add_inline_editing_attributes( 'premium_content_toggle_heading_two', 'basic' );

		$this->add_render_attribute( 'premium_content_toggle_heading_two', 'class', 'premium-content-toggle__second-label' );
