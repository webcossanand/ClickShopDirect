...
class Premium_Facebook_Reviews extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'pa', 'premium', 'premium facebook reviews', 'rating', 'testimonials', 'page', 'rate', 'recommendation', 'social' );
	}
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		foreach ( $docs as $url => $title ) {
			...
			$doc_url = Helper_Functions::get_campaign_link( $url, 'fb-reviews-widget', 'wp-editor', 'get-support' );
	...
	protected function render() {
		...
		if ( 'yes' === $settings['page_info'] && 'yes' === $settings['reviews_number'] ) {
			$page_settings['number_text'] = str_replace( '{{number}}', '%s', $settings['reviews_number_text'] );
		}
