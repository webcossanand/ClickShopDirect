...
class Premium_Site_Logo extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'pa', 'premium', 'premium site logo', 'site logo', 'retina', 'svg' );
	}
	...
	private function add_logo_content_controls( $draw_icon ) {
		...
		foreach ( $docs as $url => $title ) {
			...
			$doc_url = Helper_Functions::get_campaign_link( $url, 'logo-widget', 'wp-editor', 'get-support' );
