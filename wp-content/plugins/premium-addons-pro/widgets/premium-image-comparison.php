...
class Premium_Image_Comparison extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'pa', 'premium', 'premium image comparison', 'compare', 'before', 'after', 'slider' );
	}
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$doc1_url = Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/premium-image-comparison-widget/', 'compare-widget', 'wp-editor', 'get-support' );
	...
	protected function render() {
		...
		$img_compare_setttings = array(
			...
			'switchBefore' => 'yes' === $settings['premium_img_compare_original_img_label_switcher'],
			...
			'switchAfter'  => 'yes' === $settings['premium_image_comparison_modified_image_label_switcher'],
			...
			'mouseMove'    => 'mousemove' === $settings['premium_image_comparison_interaction_mode'],
			'clickMove'    => 'click' === $settings['premium_image_comparison_interaction_mode'],
			'showDrag'     => 'yes' === $settings['premium_image_comparison_add_drag_handle'],
			'showSep'      => 'yes' === $settings['premium_image_comparison_add_separator'],
			'overlay'      => 'yes' !== $settings['premium_image_comparison_overlay'],
