...
class Premium_Prev_Img extends Widget_Base {
    ...
    public function get_script_depends() {
		...
		if ( $is_edit ) {
			...
			$scripts = array_merge( $draw_scripts, array( 'lottie-js', 'pa-anime' ) );
			...
			if ( 'lottie' === $settings['trigger_type'] ) {
				$scripts[] = 'lottie-js';
			}
		}
	...
	public function get_keywords() {
		return array( 'pa', 'premium', 'premium preview window', 'cta', 'lightbox', 'popup', 'modal' );
	}
