...
class Premium_Facebook_Feed extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'pa', 'premium', 'premium facebook feed', 'fb', 'profile', 'account', 'post', 'page', 'social' );
	}
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$doc1_url = Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/facebook-feed-widget-tutorial/', 'fb-feed-widget', 'wp-editor', 'get-support' );
	...
	protected function get_facebook_feed() {
		...
		if ( false === $response ) {
			...
			$api_url = sprintf( 'https://graph.facebook.com/v5.0/%s/feed?fields=id,attachments{type,media{image{src}}},from,message,created_time,admin_creator,story,full_picture&limit=%s&access_token=%s', $account_id, $limit, $token );
